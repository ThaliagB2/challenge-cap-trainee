...
Read `docs/specs/features/[feature]/spec.md` and identify the domain:
...
## Template: `docs/specs/features/[feature]/context.md`

```markdown
# [Feature] Context

**Gathered:** [date]
**Spec:** `docs/specs/features/[feature]/spec.md`
