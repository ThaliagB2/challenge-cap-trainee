...
The skill creates a `docs/specs/` directory to organize all project documentation:
...
Agent: ✅ Created docs/specs/project/PROJECT.md
...
Agent: I'll analyze your existing codebase and document:
       ...
       ✅ Created 7 brownfield docs in docs/specs/codebase/
...
Agent: ✅ Created docs/specs/HANDOFF.md
