...
export class ScheduleEmergencyAppointmentUseCaseImpl implements ScheduleEmergencyAppointmentUseCase {
    ...
    public async execute (params: ScheduleEmergencyAppointmentUseCase.ScheduleEmergencyAppointmentUseCaseParams): Promise <ScheduleEmergencyAppointmentUseCase.ScheduleEmergencyAppointmentUseCaseResult>{
        try{
