...
export interface ScheduleEmergencyAppointmentUseCase {
    execute(params: ScheduleEmergencyAppointmentUseCase.ScheduleEmergencyAppointmentUseCaseParams): Promise<ScheduleEmergencyAppointmentUseCase.ScheduleEmergencyAppointmentUseCaseResult>
}
