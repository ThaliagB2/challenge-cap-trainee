...
import { LoadCustomersUseCase } from '@/data/use-cases/customers/load-customers-use-case';
...
import { FetchHttpClient } from '@/infra/http/fetch-http-client';
import { SalesOrderRepositoryImpl } from '@/infra/repositories/sales-order-repository-impl';
import { LoadSalesOrdersUseCase } from '@/data/use-cases/sales-orders/load-sales-orders-use-case';
...
import { FetchHttpClient } from '@/infra/http/fetch-http-client';
import { SalesOrderRepositoryImpl } from '@/infra/repositories/sales-order-repository-impl';
import { CloneSalesOrderUseCase } from '@/data/use-cases/sales-orders/clone-sales-order-use-case';
...
import { FetchHttpClient } from '@/infra/http/fetch-http-client';
import { SalesOrdersController } from '@/presentation/controllers/sales-orders/sales-orders-controller';
import { makeLoadSalesOrders } from '@/main/factories/use-cases/load-sales-orders';
import { makeLoadSalesOrderById } from '@/main/factories/use-cases/load-sales-order-by-id';
import { makeCloneSalesOrder } from '@/main/factories/use-cases/clone-sales-order';
