...
import '@/infra/i18n';                                        // ← i18n antes de tudo
import { ThemeAppProvider } from '@/infra/theme/theme-provider';
...
**Ordem obrigatória:**
1. `import '@/infra/i18n'` — inicializa i18next antes de qualquer componente
...
import { ThemeSettingsPage } from '@/presentation/pages/settings/theme-settings';
import { SalesOrdersPageFactory } from '@/main/factories/pages/sales-orders-page-factory';
import { SalesOrderDetailPageFactory } from '@/main/factories/pages/sales-order-detail-page-factory';
...
1. **`@/infra/i18n` é sempre o primeiro import** em `index.tsx`.
