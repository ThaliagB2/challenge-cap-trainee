...
2. **A main conhece todas as camadas** — é o único arquivo que pode importar de `domain/`, `data/`, `infra/` e `presentation/` ao mesmo tempo.
...
- ❌ Importar de `@/domain/` ou `@/data/` direto nas páginas — páginas recebem tudo via props do factory
