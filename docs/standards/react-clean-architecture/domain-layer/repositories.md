...
import { SalesOrderHeaderModel } from '@/domain/models/sales-order-header';
...
import { SalesOrderHeaderModel, SalesOrderHeaderResponse } from '@/domain/models/sales-order-header';
...
3. A interface **nunca** importa de `infra/`, `data/`, `presentation/` ou `main/`.
