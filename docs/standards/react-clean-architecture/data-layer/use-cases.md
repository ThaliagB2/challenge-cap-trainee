...
| Caminho no domain | Caminho correspondente na data |
|---|---|
| `domain/use-cases/customers/load-customers.ts` | `data/use-cases/customers/load-customers-use-case.ts` |
| `domain/use-cases/sales-orders/load-sales-orders.ts` | `data/use-cases/sales-orders/load-sales-orders-use-case.ts` |
| `domain/use-cases/sales-orders/clone-sales-order.ts` | `data/use-cases/sales-orders/clone-sales-order-use-case.ts` |

## Padrão de implementação

```typescript
// src/data/use-cases/customers/load-customers-use-case.ts

import { left, right } from '@sweet-monads/either';

import type { CustomerRepository } from '@/domain/repositories/customer-repository';
import type { LoadCustomers } from '@/domain/use-cases/customers/load-customers';
...
```typescript
// src/data/use-cases/sales-orders/load-sales-order-by-id-use-case.ts

import { left, right } from '@sweet-monads/either';

import type { SalesOrderRepository } from '@/domain/repositories/sales-order-repository';
import type { LoadSalesOrderById } from '@/domain/use-cases/sales-orders/load-sales-order-by-id';
import { AbstractError } from '@/domain/errors/abstract';
import { ServerError } from '@/domain/errors/server-error';
...
```typescript
// src/data/use-cases/sales-orders/clone-sales-order-use-case.ts

import { left, right } from '@sweet-monads/either';

import type { SalesOrderRepository } from '@/domain/repositories/sales-order-repository';
import type { CloneSalesOrder } from '@/domain/use-cases/sales-orders/clone-sales-order';
import { AbstractError } from '@/domain/errors/abstract';
import { ServerError } from '@/domain/errors/server-error';
...
```typescript
// src/data/use-cases/sales-orders/create-sales-order-use-case.ts

import { left, right } from '@sweet-monads/either';

import type { CustomerRepository } from '@/domain/repositories/customer-repository';
import type { SalesOrderRepository } from '@/domain/repositories/sales-order-repository';
import type { CreateSalesOrder } from '@/domain/use-cases/sales-orders/create-sales-order';
import { AbstractError } from '@/domain/errors/abstract';
